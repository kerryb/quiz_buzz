defmodule QuizBuzzWeb.CoreComponents do
  @moduledoc """
  ...
  def translate_error({msg, opts}) do
    ...
    if count = opts[:count] do
      Gettext.dngettext(QuizBuzzWeb.Gettext, "errors", msg, msg, count, opts)
    else
      Gettext.dgettext(QuizBuzzWeb.Gettext, "errors", msg, opts)
    end
  end
